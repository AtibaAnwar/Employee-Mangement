...
public class WelcomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(204, 204, 252));
        jPanel1.setBorder(javax.swing.BorderFactory.createCompoundBorder());

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel1.setText("Employee Management");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/New.gif"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/images1-fotor-2023070419443.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
       ...
       try{
         for(int i=1;i<=100;i++){
             Thread.sleep(50);
             w1.jLabel2.setText(Integer.toString(i)+"%");
             w1.jProgressBar1.setValue(i);
         }
